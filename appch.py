...
# --- 6. قسم التواصل وإرسال الملاحظات ---
st.markdown("---")
st.subheader("📬اكتب ملاحظة او رسالة")

# نستخدم st.form لجمع المدخلات قبل إرسالها
with st.form(key='contact_form'):
    # حقل لإيميل المُرسل (اختياري لكن مفيد للرد)
    user_email = st.text_input("بريدك الإلكتروني (اختياري)")
...
if submit_button:
    if not message_text:
        ...
        من: {user_email if user_email else 'مستخدم لم يذكر إيميله'}
